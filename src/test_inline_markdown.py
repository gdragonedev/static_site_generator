...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_images(self):
        text = "This is text with an ![image](https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/zjjcJKZ.png) and ![another](https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/dfsdkjfd.png) and this is text with a [link](https://www.example.com) and [another](https://www.example.com/another)"
    ...
    def test_split_link_single_2(self):
        node = TextNode(
        ...
        self.assertListEqual(
            [
                TextNode("link", text_type_link, "https://www.example.com/image.png"),
            ],
            new_nodes,
        )

    def test_text_to_textnodes(self):
        text = "This is **boldtext** with an *italic* word and a `code block` and an ![image](https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/zjjcJKZ.png) and a [link](https://boot.dev)"

        new_nodes = text_to_textnodes(text)
        self.assertEqual(
            [
                TextNode("This is ", text_type_text),
                TextNode("boldtext", text_type_bold),
